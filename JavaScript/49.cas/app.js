...
// Construktor funkcija za pravljenje objekta:

function User(firstName, lastName, score) {
  this.firstnaame = firstName;
  this.lastNaaame = lastName;
  this.scoreeee = score;
}
...
// Js je sinhoni jezik linija po linija po takvom redu , ansihrono
// w8engi u toj masini se izvrsava brouyer
// jsv9000.app

// sihrono
// garden.bradwoods.io/expeiments/js-engine/basic

// asihrone funkcije kada zelimo da komuniciramo sa backendom
// ferch
// promise obecanja
